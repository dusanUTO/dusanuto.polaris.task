        ...
        <ul class="navbar-nav mr-auto lg:flex lg:flex-row">
          <li class="nav-item">
            <a class="nav-link block pr-3 lg:px-4 py-2 text-black hover:text-green-600 focus:text-green-600 transition duration-150 ease-in-out"
              href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">Foundations</a>
          </li>
          <li class="nav-item">
            <a class="nav-link block pr-3 lg:px-4 py-2 text-black hover:text-green-600 focus:text-green-600 transition duration-150 ease-in-out"
              href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">Content</a>
          </li>
          <li class="nav-item">
            <a class="nav-link block pr-3 lg:px-4 py-2 text-black hover:text-green-600 focus:text-green-600 transition duration-150 ease-in-out"
              href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">Design</a>
          </li>
          <li class="nav-item mb-2 lg:mb-0">
            <a class="nav-link block pr-3 lg:px-4 py-2 text-black hover:text-green-600 focus:text-green-600 transition duration-150 ease-in-out"
              href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">Tokens</a>
          </li>
          <li class="nav-item mb-2 lg:mb-0">
            <a class="nav-link block pr-3 lg:px-4 py-2 text-black hover:text-green-600 focus:text-green-600 transition duration-150 ease-in-out"
              href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">Components</a>
          </li>
          <li class="nav-item mb-2 lg:mb-0">
            <a class="nav-link block pr-3 lg:px-4 py-2 text-black hover:text-green-600 focus:text-green-600 transition duration-150 ease-in-out"
              href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">Patterns</a>
          </li>
        </ul>
      </div>
      <searchComp />
